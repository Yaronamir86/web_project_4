...
export const profileCloseBtn = document.querySelector(".modal__close-btn_type_profile");
...
export const placeCloseBtn = document.querySelector(".modal__close-btn_type_place");
...
export const previewCloseBtn = document.querySelector(".modal__close-btn_type_preview");
